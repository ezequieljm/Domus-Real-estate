...
import { Button, Checkbox, FormControlLabel, Grow, Link, TextField, Typography } from "@material-ui/core";
    ...
    return (
        <Grow in>
            <div className="login">
                ...
                <form action="" className="form-control" onSubmit={check}>
                    <div className={classes.root}>
                        <TextField
                            ...
                            required
                            autoFocus
                            onChange={(e) => setDatosUser({ ...dataUserInput, user: e.target.value })}
                            color="primary"
                            fullWidth
                ...
                <BasicModal />
                <Typography variant="subtitle1" style={{ marginTop: "2rem", color: "grey" }}>
